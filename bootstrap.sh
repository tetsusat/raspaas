...
case "\$1" in
  ...
  scale)
    ...
    ;;
  restart)
    docker-compose -f $PAAS_HOME/app/\$APP/docker-compose.yml restart
    ;;
  ps)
    docker-compose -f $PAAS_HOME/app/\$APP/docker-compose.yml ps
    ;;
  logs)
    docker-compose -f $PAAS_HOME/app/\$APP/docker-compose.yml logs
    ;;
  *)
